...
//            ImGui_ImplVulkan_RenderDrawData(ImGui::GetDrawData()); // GUI 렌더링
    ...
    void AppBase::CreateVulkanDevice(ANativeWindow *platformWindow) {
        ...
        auto requiredExtensions = getRequiredExtensions(m_device.enableValidationLayers);
    ...
    std::vector<const char *> AppBase::getRequiredExtensions(bool enableValidation) {
